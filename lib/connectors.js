    ...
    return function (request, response, complete) {
        fs.stat(filePath, function (err, stat) {
            ...
            if (!modifiedSince(request, stat)) {
                return complete('Not Modified', new Date(stat.mtime));
            }

            return complete('OK', fs.createReadStream(filePath), {
                mimetype: mimeType,
...
exports.toDirectory = function (basePath) {
    ...
    return function (request, response, complete) {
        ...
        responderFn = exports.toFileStream.call(tube, filePath, mimetype);
        responderFn(request, response, complete);
    };
};